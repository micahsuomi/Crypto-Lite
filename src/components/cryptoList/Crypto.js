 ...
 return(
    ...
    <div className="crypto-values">
        <div className="crypto-values-list">
            ...
            <div className="crypto-value percentage-change" style={props.percentageChange > 0 ? {color:'green'} : {color:'red'}}>{props.percentageChange}%</div>
            <div className="crypto-value">{props.marketCap}</div>
